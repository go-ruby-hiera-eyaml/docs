...
The public API lives at the module root (`github.com/go-ruby-hiera-eyaml/hiera-eyaml`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `hiera-eyaml`, while the surface follows
...
```go
import "github.com/go-ruby-hiera-eyaml/hiera-eyaml"
```
...
- **[pkg.go.dev/github.com/go-ruby-hiera-eyaml/hiera-eyaml](https://pkg.go.dev/github.com/go-ruby-hiera-eyaml/hiera-eyaml)**

The module's [README](https://github.com/go-ruby-hiera-eyaml/hiera-eyaml#readme) carries worked
